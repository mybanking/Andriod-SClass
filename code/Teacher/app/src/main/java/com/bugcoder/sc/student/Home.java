...
import com.bugcoder.sc.student.course.CourseLiving;
import com.bugcoder.sc.student.course.Courses;
import com.bugcoder.sc.student.favourite.Collection;
import com.bugcoder.sc.student.schedule.Schedule;
                ...
                case 1:
                    try {
                        ...
                        for (int i = 0; i < v.size(); i++) {
                            ...
                            addSchedule((Schedule) v.elementAt(i));
    ...
    private void parseJsonWithJsonObject(String responseData) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                v.addElement(new Schedule(courseName, teacherName, time, room,date));

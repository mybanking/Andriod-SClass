...
public class TestQuestionRelease extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_question_release);
...
//                    DataJson.put("content", jsonArray);
    ...
    private void initCtrl()
    {
        ...
        LinearLayout layout = (LinearLayout) inflater.inflate(
                R.layout.questionreleasecard, null).findViewById(R.id.ReleaseOneQuestion);
        // 将布局加入到当前布局中
        lin.addView(layout);
    }
}
